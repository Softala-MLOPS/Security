# Managing Certificates and Ingress in Kubernetes

This guide provides kubectl commands for managing TLS certificates and Ingress resources in a Kubernetes cluster using cert-manager and nginx ingress controller.

**Note**: These commands are for manual management and troubleshooting. For automated setup, use the `scripts/SSL_Creation.sh` script instead.

## 1.1 Apply the Required Resources

To manually apply certificate resources:
