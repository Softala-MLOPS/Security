# How HTTPS Certificate Flow Works with cert-manager and Nginx Ingress

This guide explains the technical flow of how cert-manager, ClusterIssuer, Nginx Ingress, and application Ingress resources work together to issue and use TLS certificates.

**Context**: This describes the automated process that occurs when you run `scripts/SSL_Creation.sh` and deploy applications with Ingress resources.
